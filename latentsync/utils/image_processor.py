...
class ImageProcessor:
    ...
    def preprocess_fixed_mask_image(self, image: torch.Tensor, affine_transform=False):
        ...
        # 确保 self.mask_image 和 pixel_values 在同一个设备和数据类型上
        mask_image_on_device = self.mask_image.to(device=pixel_values.device, dtype=pixel_values.dtype)
        # 现在进行乘法操作
        masked_pixel_values = pixel_values * mask_image_on_device
